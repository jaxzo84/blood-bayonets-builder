...
const FACTIONS = {
  ...
  british_army: {
    ...
    commanders: [
      ...
      { id:'cav_cmd', name:'Cavalry Commander', pts:12, shoot:'6/6', melee:'6/7', resolve:5, experience:'Trained', cmdRange:6, cmdPts:2, isCavalryCmd:true,
    ...
    support: [
      ...
      { id:'brit_heavy_drag', isCavalry:true, name:'British Heavy Dragoons', costPerModel:6, shoot:'7/6', melee:'5/6', resolve:5, experience:'Trained',
      ...
      { id:'brit_light_drag', isCavalry:true, name:'British Light Dragoons', costPerModel:4, shoot:'7/6', melee:'6/7', resolve:6, experience:'Trained',
        minSize:4, maxSize:12, equipment:['Carbines','Standard Melee Weapons'], special:['Cavalry','Impetuous','Impact Hits (2)'],
        formations:[], upgrades:['Officer/N.C.O.','Musician','Standard Bearer'], vetCost:1 },
      { id:'brit_hussars', isCavalry:true, name:'British Hussars', costPerModel:4, shoot:'7/6', melee:'6/7', resolve:6, experience:'Trained',
        minSize:4, maxSize:12, equipment:['Carbines','Standard Melee Weapons'], special:['Cavalry','Impetuous','Vanguard','Impact Hits (2)'],
        formations:[], upgrades:['Officer/N.C.O.','Musician','Standard Bearer'], vetCost:1 },
      { id:'brunswick_hussars', isCavalry:true, name:'Brunswick Hussars', costPerModel:4, shoot:'7/6', melee:'6/7', resolve:6, experience:'Trained',
  ...
  portuguese_army: {
    ...
    support: [
      ...
      { id:'port_dragoons', isCavalry:true, name:'Portuguese Dragoons', costPerModel:3, shoot:'8/7', melee:'7/7', resolve:7, experience:'Inexperienced',
  ...
  spanish_army: {
    ...
    core: [
      { id:'span_line', name:'Spanish Line Infantry', costPerModel:2, shoot:'7/7', melee:'7/8', resolve:7, experience:'Inexperienced',
        ...
        upgrades:['Officer/N.C.O.','Musician','Standard Bearer'],
        trainedCost:1, trainedEffect:'Loses Poor Leadership, gains Battle Hardened' },
      ...
      { id:'span_militia', name:'Militia', costPerModel:2, shoot:'7/7', melee:'7/8', resolve:8, experience:'Inexperienced',
        ...
        downgradeCost:-1, downgradeEffect:'Armed with Half Pikes only (replaces Muskets)', notes:'May downgrade to -1 pt per model, armed with Half Pikes only.' },
    ],
    support: [
      ...
      { id:'span_irish', name:'Spanish Irish Line', costPerModel:3, shoot:'6/6', melee:'6/7', resolve:6, experience:'Trained',
        minSize:8, maxSize:16, equipment:['Muskets','Bayonets'], special:['Brawlers'],
        formations:['Line','Square','Loose'], upgrades:['Officer/N.C.O.','Standard Bearer','Musician'], vetCost:1 },
      { id:'span_cuirassier', isCavalry:true, name:'Spanish Cuirassier', costPerModel:5, shoot:'8/6', melee:'7/7', resolve:7, experience:'Inexperienced',
        ...
        trainedCost:1, trainedEffect:'Loses Poor Leadership, gains Battle Hardened' },
      { id:'span_dragoons', isCavalry:true, name:'Spanish Dragoons', costPerModel:3, shoot:'8/7', melee:'7/7', resolve:7, experience:'Inexperienced',
        minSize:4, maxSize:12, equipment:['Carbines','Standard Melee Weapons'], special:['Cavalry','Impact Hits (3)','Poor Leadership'],
        formations:[], upgrades:['Officer/N.C.O.','Standard Bearer','Musician'],
        trainedCost:1, trainedEffect:'Loses Poor Leadership, gains Battle Hardened' },
      { id:'span_lancer', isCavalry:true, name:'Spanish Lancers', costPerModel:3, shoot:'8/7', melee:'7/8', resolve:6, experience:'Inexperienced',
        minSize:4, maxSize:12, equipment:['Carbines','Standard Melee Weapons','Lances'], special:['Cavalry','Impact Hits (3)','Poor Leadership'],
        formations:[], upgrades:['Officer/N.C.O.','Standard Bearer','Musician'],
        trainedCost:1, trainedEffect:'Loses Poor Leadership, gains Battle Hardened' },
      { id:'span_hussar', isCavalry:true, name:'Spanish Hussars', costPerModel:3, shoot:'8/7', melee:'7/8', resolve:6, experience:'Inexperienced',
  ...
  french_army: {
    ...
    core: [
      ...
      { id:'fr_neapolitan', name:'Neapolitan Line Infantry', costPerModel:2, shoot:'7/7', melee:'7/8', resolve:7, experience:'Inexperienced',
        ...
        trainedCost:1, trainedEffect:'Loses Poor Leadership, becomes Trained' },
    ...
    support: [
      { id:'fr_voltigeurs', name:'Voltigeurs', costPerModel:4, shoot:'6/5', melee:'6/7', resolve:6, experience:'Trained',
        ...
        formations:['Line','Square'], upgrades:['Officer/N.C.O.','Musician'], vetCost:1 },
      { id:'fr_polish_lancer', isCavalry:true, name:'Polish Lancers of the Guard', costPerModel:7, shoot:'7/6', melee:'5/6', resolve:3, experience:'Veteran',
      ...
      { id:'fr_cuirassier', isCavalry:true, name:'French Cuirassier', costPerModel:6, shoot:'7/6', melee:'5/6', resolve:6, experience:'Trained',
        minSize:4, maxSize:12, equipment:['Carbines','Standard Melee Weapons'], special:['Cavalry','Impact Hits (4)'],
        formations:[], upgrades:['Officer/N.C.O.','Musician','Standard Bearer'], vetCost:1 },
      { id:'fr_dragoon', isCavalry:true, name:'French Dragoons', costPerModel:5, shoot:'7/6', melee:'6/6', resolve:6, experience:'Trained',
        minSize:4, maxSize:12, equipment:['Carbines','Standard Melee Weapons'], special:['Cavalry','Impact Hits (3)'],
        formations:[], upgrades:['Officer/N.C.O.','Musician','Standard Bearer'], vetCost:1 },
      { id:'fr_vistula', isCavalry:true, name:'Vistula Lancers', costPerModel:5, shoot:'7/6', melee:'6/6', resolve:6, experience:'Trained',
        minSize:4, maxSize:12, equipment:['Carbines','Standard Melee Weapons','Lances'], special:['Cavalry','Impact Hits (3)','Lancers'],
        formations:[], upgrades:['Officer/N.C.O.','Musician','Standard Bearer'], vetCost:1 },
      { id:'fr_chasseur', isCavalry:true, name:'Chasseurs à Cheval', costPerModel:4, shoot:'7/6', melee:'6/6', resolve:6, experience:'Trained',
        minSize:4, maxSize:12, equipment:['Carbines','Standard Melee Weapons'], special:['Cavalry','Impact Hits (2)'],
        formations:[], upgrades:['Officer/N.C.O.','Musician','Standard Bearer'], vetCost:1 },
      { id:'fr_hussars', isCavalry:true, name:'Hussars', costPerModel:4, shoot:'7/6', melee:'6/6', resolve:6, experience:'Trained',
        minSize:4, maxSize:12, equipment:['Carbines','Standard Melee Weapons'], special:['Cavalry','Impetuous','Impact Hits (2)'],
        formations:[], upgrades:['Officer/N.C.O.','Musician','Standard Bearer'], vetCost:1 },
      { id:'fr_gend_mount', isCavalry:true, name:'Gendarmes d\'Espagne (Mounted)', costPerModel:6, shoot:'7/6', melee:'5/6', resolve:5, experience:'Veteran',
        minSize:4, maxSize:12, equipment:['Carbines','Standard Melee Weapons'], special:['Cavalry','Impact Hits (3)','Steadfast'],
        formations:[], upgrades:['Officer/N.C.O.','Musician','Standard Bearer'], vetCost:1 },
      { id:'fr_gend_lancers', isCavalry:true, name:'Gendarmes d\'Espagne (Lancers)', costPerModel:6, shoot:'7/6', melee:'5/6', resolve:5, experience:'Trained',
        minSize:4, maxSize:12, equipment:['Carbines','Standard Melee Weapons','Lances'], special:['Cavalry','Impact Hits (3)','Lancers'],
  ...
  spanish_guerrillas: {
    ...
    core: [
      { id:'guerrilla_foot', name:'Guerrilla Infantry', costPerModel:2, shoot:'7/6', melee:'7/7', resolve:6, experience:'Inexperienced',
        ...
        trainedCost:1, trainedEffect:'Loses Inexperienced, becomes Trained' },
    ],
    support: [
  ...
  joseph_army: {
    ...
    support: [
      ...
      { id:'jos_voltigeurs', name:'Spanish Voltigeurs', costPerModel:3, shoot:'7/6', melee:'7/8', resolve:6, experience:'Inexperienced',
        ...
        formations:['Line','Square'], upgrades:['Officer/N.C.O.','Musician','Standard Bearer'],
        trainedCost:1, trainedEffect:'Loses Poor Leadership, gains Battle Hardened' },
      { id:'jos_heavy_cav', isCavalry:true, name:'Spanish Heavy Cavalry', costPerModel:4, shoot:'8/6', melee:'7/7', resolve:7, experience:'Inexperienced',
        minSize:4, maxSize:12, equipment:['Carbines','Standard Melee Weapons'], special:['Cavalry','Impact Hits (4)','Poor Leadership'],
        formations:[], upgrades:['Officer/N.C.O.','Musician','Standard Bearer'],
        trainedCost:1, trainedEffect:'Loses Poor Leadership, gains Battle Hardened' },
      { id:'jos_lancers', isCavalry:true, name:'Spanish Lancers', costPerModel:3, shoot:'8/7', melee:'7/8', resolve:6, experience:'Inexperienced',
        minSize:4, maxSize:12, equipment:['Carbines','Standard Melee Weapons','Lances'], special:['Cavalry','Impact Hits (3)','Poor Leadership'],
        formations:[], upgrades:['Officer/N.C.O.','Musician','Standard Bearer'],
        trainedCost:1, trainedEffect:'Loses Poor Leadership, gains Battle Hardened' },
      { id:'jos_hussars', isCavalry:true, name:'Spanish Hussars', costPerModel:3, shoot:'8/7', melee:'7/8', resolve:6, experience:'Inexperienced',
        minSize:4, maxSize:12, equipment:['Carbines','Standard Melee Weapons'], special:['Cavalry','Impetuous','Vanguard','Impact Hits (2)','Poor Leadership'],
        formations:[], upgrades:['Officer/N.C.O.','Musician','Standard Bearer'],
        trainedCost:1, trainedEffect:'Loses Poor Leadership, gains Battle Hardened' },
